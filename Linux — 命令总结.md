...
- #### 文件移动
  ```
  // 将 /foo 目录下的 file1 复制到 /bar 目录，并将文件名改为 file2
  mv /foo/file1 /bar/file2
  ```
...
---
- #### du 查看当前目录下各个文件占用的磁盘空间
  ```
  // h 表示 human, 人类可以理解的单位，比如 K、M、G
  du -h 
